...
class DigestControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    DigestController.any_instance.stubs(:set_sidebar_memberships)
    DigestController.any_instance.stubs(:digest_nav_markup).returns("")
    DigestController.any_instance.stubs(:digest_sidebar_markup).returns("")
  end
